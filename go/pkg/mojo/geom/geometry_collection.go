...
func init() {
	jsoniter.RegisterTypeDecoder("geom.GeometryCollection", &GeometryCollectionCodec{})
	jsoniter.RegisterTypeEncoder("geom.GeometryCollection", &GeometryCollectionCodec{})
}

func (p *GeometryCollection) AddGeometries(geometries ...*Geometry) {
	p.Geometries = append(p.Geometries, geometries...)
}
