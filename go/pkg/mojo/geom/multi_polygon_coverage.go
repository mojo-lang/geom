...
func (p MultiPolygon) CellCovering(minLevel, maxLevel, maxCells int) s2.CellUnion {
	cells := s2.CellUnion{}
...
func (p MultiPolygon) GeoHashCovering(minLevel, maxLevel, maxHashes int) []string {
	var hashes []string
	for _, polygon := range p.Polygons {
